...
format: html
>>>>>>> 8c20beaa9e2a74d9e4a0618a6d2923dae04b09a6
---
...
results.to_csv('jackknife_simulation_results-n1000.csv',index=False)
# plot simulation results
plt.rcParams.update({'font.size': 14})
...
plt.ylabel('Coverage')
plt.legend()
plt.savefig('jackknife_simulation_coverage-n1000.png',dpi=400,bbox_inches='tight')
plt.show()
...
plt.ylabel('Interval width')
plt.legend()
plt.savefig('jackknife_simulation_width-n1000.png',dpi=400,bbox_inches='tight')
plt.show()
```