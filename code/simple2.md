...
``` r
results %>%
    ggplot(aes(x = mean_b1, y = median_interval_width, colour = as.factor(training_set_size))) +
    geom_point()
```

![](simple2_files/figure-commonmark/unnamed-chunk-6-1.png)

``` r
ggsave(here::here("figures", "mean_b1_vs_median_interval_width.png"), width = 10, height = 10)
```
...
```
    ...
    [c0fb1c9] 2023-04-23: feat: added new plot to look at effect of betahat estimate on median interval width
