...
results = pd.DataFrame(columns = ['itrial','d','method','coverage','width', 'n'])
# loop over n_vals
for n in n_vals:
    ...
    for itrial in range(ntrial):
        ...
        results.loc[len(results)]=[itrial,d,method,coverage,width,n]
    Y_dic[n] = Ya
```

```{r, get_python_results, eval = TRUE}
...
# need to accommodate varying number of beta1_hat_fold_* columns
tt_intermediate <- tl %>%
